...
from googlenet_v1 import V1_slim
from googlenet_v3 import V3_slim
...
# train_path='G:\\Network\\3_GoogLeNet\\train_data'
logs_path='G:\\MYWORK\\3_GoogLeNet\\logs'
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples / batch_size) == 0:
            ...
            saver.save(session, './GoogLeNet_v1-model/save_model.pd', global_step=i)  # 保存模型

    total_iterations += num_iteration
#######################################正式训练########################################
train(num_iteration=88)
####################################启动可视化###################################
# #cd G:\MYWORK\3_GoogLeNet
# G:
# activate tensorflow
