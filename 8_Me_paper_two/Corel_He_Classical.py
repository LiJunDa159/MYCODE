...
logs_train_path = 'G:/PyCharm/Lunwen3/logs2_He/train'
logs_val_path='G:/PyCharm/Lunwen3/logs2_He/val'
logs_test_path='G:/PyCharm/Lunwen3/logs2_He/test'
...
def create_convolutional_layer(input,
                                 ...
                                 conv_filter_size,
                                 num_filters):
    weights = create_weights_conv(shape=[conv_filter_size, conv_filter_size, num_input_channels, num_filters])
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        feed_dict_tr = {x: x_train_batch,
                        y_true: y_train_batch,keep_prob: 0.95}
        ...
        if i % int(train_data.train.num_examples / batch_size) == 0:
            ...
            saver.save(session, './corel-He-classical-model/save_model.pd', global_step=i)  # 保存模型
