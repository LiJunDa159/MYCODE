...
logs_train_path = 'G:/PyCharm/Lunwen3/logs2_W/train'
logs_val_path='G:/PyCharm/Lunwen3/logs2_W/val'
logs_test_path='G:/PyCharm/Lunwen3/logs2_W/test'
...
W1=np.load(r"G:\PyCharm\Lunwen3\Ws_corel\W1.npy")
W2=np.load(r"G:\PyCharm\Lunwen3\Ws_corel\W2.npy")
W3=np.load(r"G:\PyCharm\Lunwen3\Ws_corel\W3.npy")
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(train_data.train.num_examples / batch_size) == 0:
            ...
            saver.save(session, './corel-W-classical-model/save_model.pd', global_step=i)  # 保存模型
