...
W1=PCA_feature(cifar_data,1,7,7,5,12,12)
# W1=z_score(W1)
feature1_imgs=myconv(cifar_data,W1)

#第二层权重与第二个特征图
W2=PCA_feature(feature1_imgs,10,11,11,3,7,64)
# W2=z_score(W2)
feature2_imgs=myconv(feature1_imgs,W2)

#第三层权重与第三个特征图
W3=PCA_feature(feature2_imgs,20,11,11,3,7,128)
# W3=z_score(W3)


np.save(r"G:\PyCharm\Lunwen3\Ws_PCA_cifar\W1.npy", W1)
np.save(r"G:\PyCharm\Lunwen3\Ws_PCA_cifar\W2.npy", W2)
np.save(r"G:\PyCharm\Lunwen3\Ws_PCA_cifar\W3.npy", W3)
